...
- - Getstarted
  ...
  - <a href="index.html" class="current">Theme color reference</a>
    - [Theme Color Reference](#theme-color-reference)
    - <a href="#contrast-colors" class="toctree-l4">Contrast Colors</a>
    - <a href="#base-colors" class="toctree-l4">Base Colors</a>
    - <a href="#button-control" class="toctree-l4">Button Control</a>
    - <a href="#dropdown-control" class="toctree-l4">Dropdown Control</a>
    - <a href="#input-control" class="toctree-l4">Input Control</a>
    - <a href="#scroll-bar-control" class="toctree-l4">Scroll Bar Control</a>
    - <a href="#badge" class="toctree-l4">Badge</a>
    - <a href="#progress-bar" class="toctree-l4">Progress Bar</a>
    - <a href="#lists-and-trees" class="toctree-l4">Lists and Trees</a>
    - <a href="#activity-bar" class="toctree-l4">Activity Bar</a>
    - <a href="#side-bar" class="toctree-l4">Side Bar</a>
    - <a href="#editor-groups-tabs" class="toctree-l4">Editor Groups &amp; Tabs</a>
    - <a href="#editor-colors" class="toctree-l4">Editor Colors</a>
    - <a href="#diff-editor-colors" class="toctree-l4">Diff Editor Colors</a>
    - <a href="#editor-widget-colors" class="toctree-l4">Editor Widget Colors</a>
    - <a href="#peek-view-colors" class="toctree-l4">Peek View Colors</a>
    - <a href="#merge-conflicts" class="toctree-l4">Merge Conflicts</a>
    - <a href="#panel-colors" class="toctree-l4">Panel Colors</a>
    - <a href="#status-bar-colors" class="toctree-l4">Status Bar Colors</a>
    - <a href="#title-bar-colors-macos" class="toctree-l4">Title Bar Colors (macOS)</a>
    - <a href="#notification-dialog-colors" class="toctree-l4">Notification Dialog Colors</a>
    - <a href="#extensions" class="toctree-l4">Extensions</a>
    - <a href="#quick-picker" class="toctree-l4">Quick Picker</a>
    - <a href="#integrated-terminal-colors" class="toctree-l4">Integrated Terminal Colors</a>
    - <a href="#debug" class="toctree-l4">Debug</a>
    - <a href="#welcome-page" class="toctree-l4">Welcome Page</a>
...
You can customize your active Visual Studio Code [color theme](https://vscode.readthedocs.io/docs/getstarted/themes.md) with the `workbench.colorCustomizations` user [setting](https://vscode.readthedocs.io/docs/getstarted/settings.md).
...
<a href="../themes/index.html" class="btn btn-neutral float-right" title="Themes">Next <span class="icon icon-circle-arrow-right"></span></a> <a href="../settings/index.html" class="btn btn-neutral" title="Settings"><span class="icon icon-circle-arrow-left"></span> Previous</a>
